...
constexpr static uint32 RENDERER_SCENE_DESCRIPTOR_SET_IDX = 1;
constexpr static uint32 RENDERER_PASS_DESCRIPTOR_SET_IDX = 2;
constexpr static uint32 RENDERER_MATERIAL_DESCRIPTOR_SET_IDX = 3;
constexpr static uint32 RENDERER_ENTITY_DESCRIPTOR_SET_IDX = 4;
constexpr static uint32 APP_FIRST_DESCRIPTOR_SET_IDX = 5;

constexpr static uint32 SHADOW_MAPPING_CASCADE_COUNT = 4;

constexpr static uint32 MAX_COMMAND_BUFFERS_PER_FRAME = 16;
