...
struct CameraController {
    ...
    CameraController(float cameraZoomSpeed, float cameraMoveSpeed) :
        cameraZoomSpeed(cameraZoomSpeed), cameraMoveSpeed(cameraMoveSpeed) {}
...
struct CameraController2D : public CameraController {
    CameraController2D() = default;
    CameraController2D(float cameraZoomSpeed, float cameraMoveSpeed, bool enableRotation, float cameraRotationSpeed) :
        CameraController(cameraZoomSpeed, cameraMoveSpeed), enableRotation(enableRotation),
...
struct RotateCameraController : public CameraController {
    /*
     * (r, theta, z)
     * r = cilinder radius
